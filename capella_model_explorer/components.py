...
from capella_model_explorer import icons, main, state, templates
        ...
        breadcrumbs = [
            state.Breadcrumb(
                ...
                url=main.app.url_path_for(
                    "template_page", template_id=state.template.id
                ),
            ),
        ]
        ...
        breadcrumbs.append(
            state.Breadcrumb(
                ...
                url=main.app.url_path_for(
                    ...
                    model_element_uuid=state.model_element.uuid,
                ),
            )
        )
        ...
        ft.Li(
            ft.Div(
                ft.A(
                    ...
                    href=main.url_path_for(main.homepage),
                ),
                cls="flex items-center",
            ),
            cls="flex",
...
def search_field() -> t.Any:
    ...
    return ft.Div(
        ft.Input(
            ...
            hx_get=main.app.url_path_for("model_object_list"),
            hx_swap="outerHTML",
...
def template_card(template: templates.Template) -> t.Any:
    url = main.url_path_for(main.template_page, template_id=template.id)
    return ft.A(
        ft.Div(
            ft.Div(
                template.name,
