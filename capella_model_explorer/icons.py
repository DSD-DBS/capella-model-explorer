...
def logo() -> t.Any:
    return (
        svg.Svg(
            ft.Style(".st0{fill:#f01414}.st1{fill:#fff}"),
            svg.Path(
...
def lock_icon(state: t.Literal["open", "closed"]) -> t.Any:
    if state == "open":
        d = (
