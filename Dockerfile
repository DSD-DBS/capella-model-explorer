...
RUN TAILWIND_CSS_VERSION="$(uv run python3 -c 'import capella_model_explorer.constants as c; print(c.Defaults.tailwind_css_version)')" && \
  TAILWIND_CSS_CLI_VERSION="$(uv run python3 -c 'import capella_model_explorer.constants as c; print(c.Defaults.tailwind_css_cli_version)')" && \
  TAILWIND_CSS_TYPOGRAPHY_VERSION="$(uv run python3 -c 'import capella_model_explorer.constants as c; print(c.Defaults.tailwind_css_typography_version)')" && \
