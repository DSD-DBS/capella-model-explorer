...
def run_local():
    ...
    subprocess.run(
        ...
        | {
            ...
            "CME_TAILWIND_CSS_VERSION": c.Defaults.tailwind_css_version,
            "CME_TAILWIND_CSS_TYPOGRAPHY_VERSION": (
                c.Defaults.tailwind_css_typography_version
            ),
...
def build_css(watch):
    ...
    _install_npm_pkgs(
        [
            f"tailwindcss@{c.Defaults.tailwind_css_version}",
            f"@tailwindcss/cli@{c.Defaults.tailwind_css_cli_version}",
            "@tailwindcss/"
            f"typography@{c.Defaults.tailwind_css_typography_version}",
        ]
    )
...
def build_image():
    ...
    cmd = [
        ...
        "--no-cache",
        "--build-arg",
        f"TAILWIND_CSS_VERSION={c.Defaults.tailwind_css_version}",
        "--build-arg",
        f"TAILWIND_CSS_CLI_VERSION={c.Defaults.tailwind_css_cli_version}",
        "--build-arg",
        "TAILWIND_CSS_TYPOGRAPHY_VERSION"
        f"={c.Defaults.tailwind_css_typography_version}",
        "-t",
